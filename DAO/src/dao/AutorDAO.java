...
public class AutorDAO {
	...
	private static String SELECT = String.format("SELECT * FROM %1$s", Autor.tbName);
	private static String SELECTBYPK = String.format("SELECT * FROM %1$s WHERE id=?",Autor.tbName);
	...
	private static String DELETE = String.format("DELETE FROM %1$s where id = ?",Autor.tbName);
